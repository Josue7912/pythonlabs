...
class Movie:
    ...
    def __str__(self):
        return f"{self.title} is a movie from {self.year}"
...
class ActionMovie(Movie):
    ...
    def __str__(self):
        return f"{self.title} has a pg of {self.pg} and it's from {self.year}"

film = Movie("1990", "Rambo")
actionfilm = ActionMovie("2000", "Transporter")
print(film)
print(actionfilm)